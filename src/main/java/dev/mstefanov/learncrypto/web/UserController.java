...
import dev.mstefanov.learncrypto.model.binding.UserRegistrationBindingModel;
    ...
    public String register(@Valid @ModelAttribute("userRegistrationBindingModel")
        ...
        if (bindingResult.hasErrors()) {
            ...
            if (!userRegistrationBindingModel.getPassword().equals(userRegistrationBindingModel.getConfirmPassword())) {
                ...
                this.userService.registerUser(this.modelMapper.map(userRegistrationBindingModel, UserServiceModel.class));
            }
        }
